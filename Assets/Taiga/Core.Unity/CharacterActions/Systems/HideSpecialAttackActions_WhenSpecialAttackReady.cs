...
{
    public class HideSpecialAttackActions_WhenSpecialAttackReady : ReactiveSystem<GameEntity>
    {
        GameContext game;

        public HideSpecialAttackActions_WhenSpecialAttackReady(Contexts contexts) : base(contexts.game)
        {
        ...
        protected override bool Filter(GameEntity entity)
        {
            ...
            return actionType == CharacterActionType.SpecialAttack;
        }

        protected override ICollector<GameEntity> GetTrigger(IContext<GameEntity> context)
        {
            return context.CreateCollector(
                CharacterActionAttackEvents.OnSpecialAttackReady.Added()
            );
        }
    }
}
