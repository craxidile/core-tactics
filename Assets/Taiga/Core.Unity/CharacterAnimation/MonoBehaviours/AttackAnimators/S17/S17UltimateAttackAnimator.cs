...
namespace Taiga.Core.Unity.CharacterAnimation
{
    ...
    public class S17UltimateAttackAnimator : ICharacterAttackAnimator
    {
        ...
        )
        {
            ...
            var attackingController = ultimateAttackController.AddComponent<S17UltimateAttack01AttackingController>();
            attackingController.CharacterAnimator = characterAnimator;
            attackingController.Direction = direction;
            attackingController.Animation = UltimateAttackPreset.GetAnimationByName("s17_001");
        ...
        )
        {
            ...
            var ultimateAttackController = characterAnimator.ultimateAttackController.gameObject;
            var attackedController = ultimateAttackController.AddComponent<S17UltimateAttack01AttackedController>();
            attackedController.Animation = UltimateAttackPreset.GetAnimationByName("s17_001");
