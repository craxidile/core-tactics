...
{
    public class S17UltimateAttack01AttackingController : BaseS17UltimateAttack01
    {
        ...
        private Vector3 _animEffectPosition; 
        ...
        internal override Sequence Initialize()
        {
            ...
            _originalEffectPosition = effect.transform.localPosition;
            _animEffectPosition = _originalEffectPosition + new Vector3(0.0707f , 0.0f, 0.0707f); 
            _effect.transform.localPosition = _animEffectPosition;
