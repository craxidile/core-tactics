...
namespace Taiga.Core.Unity.CharacterAnimation
{
    ...
    public class S22UltimateAttack00Animator : ICharacterAttackAnimator
    {
        ...
        )
        {
            ...
            var attackingController = ultimateAttackController.AddComponent<S22UltimateAttack00AttackingController>();
            attackingController.CharacterAnimator = characterAnimator;
            attackingController.Direction = direction;
            attackingController.Animation = UltimateAttackPreset.GetAnimationByName("S22_000");
        ...
        )
        {
            ...
            var ultimateAttackController = characterAnimator.ultimateAttackController.gameObject;
            var attackedController = ultimateAttackController.AddComponent<S22UltimateAttack00AttackedController>();
            attackedController.Animation = UltimateAttackPreset.GetAnimationByName("S22_000");
