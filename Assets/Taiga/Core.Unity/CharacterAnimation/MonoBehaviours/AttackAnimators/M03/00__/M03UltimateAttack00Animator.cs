...
namespace Taiga.Core.Unity.CharacterAnimation
{
    ...
    public class M03UltimateAttack00Animator : ICharacterAttackAnimator
    {
        ...
        )
        {
            ...
            var attackingController = ultimateAttackController.AddComponent<M03UltimateAttack00AttackingController>();
            attackingController.CharacterAnimator = characterAnimator;
            attackingController.Direction = direction;
            attackingController.Animation = UltimateAttackPreset.GetAnimationByName("m03_000");
        ...
        )
        {
            ...
            var ultimateAttackController = characterAnimator.ultimateAttackController.gameObject;
            var attackedController = ultimateAttackController.AddComponent<M03UltimateAttack00AttackedController>();
            attackedController.Animation = UltimateAttackPreset.GetAnimationByName("m03_000");
