...
namespace Taiga.Core.Unity.CharacterAnimation
{
    ...
    public class M09UltimateAttack00Animator : ICharacterAttackAnimator
    {
        ...
        )
        {
            ...
            var attackingController = ultimateAttackController.AddComponent<M09UltimateAttack00AttackingController>();
            attackingController.CharacterAnimator = characterAnimator;
            attackingController.Direction = direction;
            attackingController.Animation = UltimateAttackPreset.GetAnimationByName("m09_000");
        ...
        )
        {
            ...
            var ultimateAttackController = characterAnimator.ultimateAttackController.gameObject;
            var attackedController = ultimateAttackController.AddComponent<M09UltimateAttack00AttackedController>();
            attackedController.Animation = UltimateAttackPreset.GetAnimationByName("m09_000");
