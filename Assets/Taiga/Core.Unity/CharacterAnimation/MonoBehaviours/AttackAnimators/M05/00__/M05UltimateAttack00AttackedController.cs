...
{
    public class M05UltimateAttack00AttackedController : BaseM05UltimateAttack00
    {
        ...
        internal void ShowEffect5()
        {
            ...
            var characterStatus = CharacterAnimator.root.gameObject.GetComponent<CharacterStatusPresenter>();
            characterStatus.SetComboText(1, false);
        }
