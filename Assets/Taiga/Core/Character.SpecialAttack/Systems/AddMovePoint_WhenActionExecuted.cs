...
{
    public class AddMovePoint_WhenActionExecuted : ReactiveSystem<GameEntity>
    {
        private GameContext game;
        
        public AddMovePoint_WhenActionExecuted(Contexts contexts) : base(contexts.game)
        {
        ...
        protected override void Execute(List<GameEntity> entities)
        {
            foreach (var entity in entities)
            {
                ...
                specialAttack.AddPoint(CharacterEntity_SpecialAttack.SpecialAttackPointType.WalkPoint);
            }
        }
