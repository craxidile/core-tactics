...
{
    public class RowAttack_Strategy : DirectionAttackStrategy
    {
        readonly int attackPoint;
        readonly int bumpDistance = 0;
        readonly BumpType? bumpType;

        public RowAttack_Strategy(CharacterEntity character, int attackPoint, int bumpDistance = 0, BumpType? bumpType = null) : base(character)
        {
